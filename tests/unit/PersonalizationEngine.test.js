...
describe('PersonalizationEngine', () => {
	...
	describe('constructor validation', () => {
		it('should throw error without inferenceEngine', () => {
			assert.throws(() => new PersonalizationEngine(), /requires inferenceEngine/i);
		});
		...
		it('should throw error with null', () => {
			assert.throws(() => new PersonalizationEngine(null), /requires inferenceEngine/i);
		});
	});
	...
	describe('core functionality', () => {
		...
		it('should enhance products with similarity scores', async () => {
			...
			const enhanced = await personalizationEngine.enhanceProducts(products, userContext);
		...
		it('should track statistics', async () => {
			...
			mockInferenceEngine.predict = async () => [Array(512).fill(0.1), Array(512).fill(0.2)];
		...
		it('should track errors', async () => {
			...
			const result = await personalizationEngine.calculateSimilarity(['text1', 'text2']);
	...
	describe('model flexibility', () => {
		it('should support different output dimensions', async () => {
			...
			const similarities = await personalizationEngine.calculateSimilarity(['text1', 'text2']);
		...
		it('should work with Ollama embeddings', async () => {
			...
			const products = [{ name: 'Test Product', description: 'Test description' }];
